[🏠 Document Start](../../../README.md) / [MetaTrader 5 Trading Platform](../../../MetaTrader-5-Trading-Platform.md) / [Platform Setup](../../Platform-Setup.md) / [Reports](../Reports.md) / Equity
...
The report contains the following data:
  ...
  * Credit — amount of credit transactions in the accounts for the specified period;
  ...
  * Margin — amount of funds necessary to cover open positions in the accounts as of the end of each day included in the specified period. It is calculated as Margin for day 1 + Margin for day 2, etc.;
