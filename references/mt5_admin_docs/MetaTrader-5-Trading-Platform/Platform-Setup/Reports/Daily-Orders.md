[🏠 Document Start](../../../README.md) / [MetaTrader 5 Trading Platform](../../../MetaTrader-5-Trading-Platform.md) / [Platform Setup](../../Platform-Setup.md) / [Reports](../Reports.md) / Daily Orders

[Previous](Daily-Trades.md) | [Next](Daily-Positions.md)

# Daily Orders Report

Daily Orders Report features information about [market and pending orders](../Orders.md) which remained open (active) at the end of the selected day.
...
The report is presented as a table displaying the following order data:
  ...
  * Reason — [reason (#reason)](../Orders.md#reason) for placing the order.
  * State — [order state (#state)](../Orders.md#state) at the end of the day for which the report is generated.
