[🏠 Document Start](../../../README.md) / [MetaTrader 5 Trading Platform](../../../MetaTrader-5-Trading-Platform.md) / [Platform Setup](../../Platform-Setup.md) / [Reports](../Reports.md) / Lifetime Value
...
This report features FTD (first-time deposit) and LTV (lifetime value) metrics concerning your [clients](../Clients.md) rather than separate accounts. The report collects data on all accounts belonging to a client and generates summary information: the date and amount of the first deposit, as well as the amount of deposits on all accounts over a selected period of time.
