[🏠 Document Start](../../../README.md) / [MetaTrader 5 Trading Platform](../../../MetaTrader-5-Trading-Platform.md) / [Platform Setup](../../Platform-Setup.md) / [Reports](../Reports.md) / Positions History
...
The report displays the following information on positions:
  ...
  * Fee — total [fee (#type)](../Groups/Commission-Settings.md#type) for all deals related to the position.
