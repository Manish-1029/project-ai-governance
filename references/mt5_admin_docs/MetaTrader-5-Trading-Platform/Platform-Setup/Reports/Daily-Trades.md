[🏠 Document Start](../../../README.md) / [MetaTrader 5 Trading Platform](../../../MetaTrader-5-Trading-Platform.md) / [Platform Setup](../../Platform-Setup.md) / [Reports](../Reports.md) / Daily Trades
...
Additional parameters are set in the report configuration of MetaTrader 5 Administrator:
  ...
  * Currency — currency used for displaying various parameters in the report (Balance, Profit, etc.).
...
The following data on the deals is shown:
  ...
  * Symbol — the symbol, for which the deal is executed;
...
The following data on the most profitable accounts is displayed:
  ...
  * Floating P/L, currency — floating profit/loss of open positions in the account at the moment of the report request;
