[🏠 Document Start](../../../README.md) / [MetaTrader 5 Trading Platform](../../../MetaTrader-5-Trading-Platform.md) / [Platform Setup](../../Platform-Setup.md) / [Reports](../Reports.md) / Trade Group Statistics

[Previous](Trade-Performance-Summary.md) | [Next](StopOut-Compensations.md)
...
The information in the report is divided into blocks by group types: real, demo and contest.
  ...
  * Trade: Other — the share of trades executed by [other methods (#reason)](../Deals.md#reason).
