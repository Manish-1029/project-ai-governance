[🏠 Document Start](../../../README.md) / [MetaTrader 5 Trading Platform](../../../MetaTrader-5-Trading-Platform.md) / [Platform Setup](../../Platform-Setup.md) / [Reports](../Reports.md) / Fund Overview

[Previous](EMIR.md) | [Next](Risk-Appetite.md)

# Fund Overview

If you are using the MetaTrader 5 platform for [the operation of an investment fund](../Funds-&-ETF.md), this report will show the key fund performance characteristics, including Assets Under Management and Net Asset Value, as well as information about fund investors and managers.

![The "Fund Overview" report](images/fund_overview_report.png)
