[🏠 Document Start](../../../README.md) / [MetaTrader 5 Trading Platform](../../../MetaTrader-5-Trading-Platform.md) / [Platform Setup](../../Platform-Setup.md) / [Reports](../Reports.md) / Daily Expert Advisors

[Previous](Daily-Positions.md) | [Next](Deals-History.md)

# Daily Expert Advisors Report
...
The following parameters should be specified before requesting a report in the manager terminal:
  ...
  * Groups — groups with the accounts used for generating a report;
  * Period — reports are generated for the last seven days up to the specified day.
...
Additional parameters are specified in the report configuration of MetaTrader 5 Administrator:
  ...
  * Currency — currency used when displaying various parameters in the report (Balance, Profit, etc.).
