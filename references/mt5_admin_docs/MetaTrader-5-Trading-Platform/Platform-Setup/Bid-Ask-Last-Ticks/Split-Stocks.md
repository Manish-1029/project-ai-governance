[🏠 Document Start](../../../README.md) / [MetaTrader 5 Trading Platform](../../../MetaTrader-5-Trading-Platform.md) / [Platform Setup](../../Platform-Setup.md) / [Bid/Ask/Last Ticks](../BidAskLast-Ticks.md) / Split Stocks

[Previous](Import-Tick-Data.md) | [Next](../Synchronization.md)
...
The appropriate operations (stock splitting/consolidation) can be executed on the trading platform's side as well:
  ...
  * Transforming the [minute](../1-Minute-History-Charts/Split-Stocks.md) and tick symbol history means proportional increase or decrease in prices, spreads and volumes.
...
![Transforming tick data when splitting stocks](images/split_ticks.png)
...
Go to the "Bid/Ask/Last Ticks" section and select "![Split Scanner](images/split_scanner_icon.png)Split Scanner" in the context menu. Next, select a group of symbols and click "Scan". Check the received split points. The list will display:
