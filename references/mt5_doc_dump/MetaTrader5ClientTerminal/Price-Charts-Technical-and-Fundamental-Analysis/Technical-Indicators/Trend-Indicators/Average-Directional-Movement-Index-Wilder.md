[🏠 Document Start](../../../README.md) / [Price Charts, Technical and Fundamental Analysis](../../README.md) / [Technical Indicators](../../Technical-Indicators.md) / [Trend Indicators](../Trend-Indicators.md) / Average Directional Movement Index Wilder

[Previous](Average-Directional-Movement-Index.md) | [Next](Bollinger-Bands.md)
...
Trading rules of this indicator are described in the section ["Average Directional Movement Index"](Average-Directional-Movement-Index.md).

![Average Directional Movement Index Wilder](images/admiw.png)
...
SMMA(X, N, i) — [Smoothed Moving Average (#smma)](Moving-Average.md#smma) by values of X series on the current bar;  
