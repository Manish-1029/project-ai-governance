...
[Previous](Custom-Financial-Instruments.md) | [Next](Futures.md)
...
All possible options of entering the spread are specified at the bottom of the [symbol specification window (#specification)](../Market-Watch.md#specification):
