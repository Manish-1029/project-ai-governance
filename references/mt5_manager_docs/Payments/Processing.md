[🏠 Document Start](../README.md) / [Payments](README.md) / Processing

[Previous](Controlling.md) | [Next](../App-Store/README.md)
...
> Access to transaction processing is determined by the manager account permissions. If the section is not available, please contact your platform administrator.
...
For withdrawals, the process is as follows:
  ...
  * An [active payment](Controlling.md) with the "Pending" status is created in the platform. A unique internal number is automatically assigned to it.
