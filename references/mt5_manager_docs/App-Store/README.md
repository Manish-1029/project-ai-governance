[🏠 Document Start](../README.md) / App Store

[Previous](../Payments/Processing.md) | [Next](../Technical-Support/README.md)
...
![The App Store for expanding the MetaTrader 5 platform capabilities](images/appstore.png)
...
![Ordering an application from the App Store](images/appstore_order.png)

  * The price of some applications may include mandatory monthly technical support fees.
  * [MetaQuotes support site](https://support.metaquotes.net/) account is required for accessing the App Store section. Specify the account credentials in the [Manager terminal settings (#support)](../MetaTrader-5-Manager/Terminal-Settings.md#support).
