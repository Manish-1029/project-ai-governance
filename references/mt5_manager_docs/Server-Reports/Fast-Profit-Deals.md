[🏠 Document Start](../README.md) / [Server Reports](README.md) / Fast Profit Deals

[Previous](Risk-Appetite.md) | [Next](../Analytics/README.md)
...
The following information is available for the deals:
  ...
  * Reason — [reason (#deal-reason)](../Trading-Operations/Viewing-and-Editing.md#deal-reason) for executing the deal.
