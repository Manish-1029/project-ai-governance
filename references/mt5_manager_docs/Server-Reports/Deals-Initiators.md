[🏠 Document Start](../README.md) / [Server Reports](README.md) / Deals Initiators

[Previous](Deals-Profit.md) | [Next](Deals-Geography.md)

# Deals Initiators

Deal Initiators ([reasons (#reason)](../Trading-Operations/Working-with-Trading-Orders.md#reason)) report. The report demonstrates how traders prefer to perform operations: manually from the desktop or mobile terminal, using trading robots or copying signals. In addition, it shows which methods generate the greatest profit and loss. 
...
The report includes multiple charts grouped into categories:
  ...
  * Volume — distribution of the total volume of deals execution [reasons (#reason)](../Trading-Operations/Working-with-Trading-Orders.md#reason) and by time.
