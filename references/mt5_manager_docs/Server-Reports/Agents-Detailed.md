[🏠 Document Start](../README.md) / [Server Reports](README.md) / Agents Detailed

[Previous](Agents.md) | [Next](Credit-Facility.md)

# Agents Detailed Report

Agents Detailed Report is a detailed report on agent commissions. The report reflects deals related to paying commissions [accumulated during a trading day/month (#charge)](../Managing-Trade-Server-Settings/Spread-Commission-and-Swap.md#charge), as well as client deals, for which the agent received immediate commissions.
...
The following details are shows for deals, for which the client immediately received commission (immediate charge):
  ...
  * Deal — ticket of the deal.
  * Account — number of the account, at which the deal was performed.
  * Name — account holder's name.
  * Time — time of the deal. The record has a format of YYYY.MM.DD HH:MM (year.month.day hour:minute).
  * Position — ticket of the position, to which the deal is related.
  * Symbol — symbol, for which the deal was executed.
  ...
  * Price — price, at which the deal is executed.
  * Commission — [standard commission (#commission)](../Managing-Trade-Server-Settings/Spread-Commission-and-Swap.md#commission) for the deal.
...
The following data is provided for deals related to agent commissions accumulated during a day/month:
  ...
  * Account — number of the account, for which the commission on deals was accumulated.
  * Name — account holder's name.
