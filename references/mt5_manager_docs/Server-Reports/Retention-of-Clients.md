[🏠 Document Start](../README.md) / [Server Reports](README.md) / Retention of Clients
...
The report is generated based on [clients](../Clients-and-Trading-Accounts/Clients.md). A client can have multiple trading accounts, and thus only one (the first) connection from any of the accounts will be reflected in the report.
