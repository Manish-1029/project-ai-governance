[🏠 Document Start](../README.md) / [Server Reports](README.md) / Daily Positions

[Previous](Daily-Orders.md) | [Next](Daily-Expert-Advisors.md)

# Daily Positions

Daily Positions Report features information about [trading positions](../Trading-Operations/Working-with-Trading-Positions.md) which remained open at the end of the selected day.
...
> Daily reports must be enabled on the server for the group containing the necessary accounts, to generate this type of reports.
...
The report is presented as a table displaying the following position data:
  ...
  * Login — the account of the [number](../Clients-and-Trading-Accounts/README.md) on which the position was opened.
  ...
  * Commission — the amount of position withheld on the position. It is calculated as the sum of commissions on [deals (#deal)](../Trading-Operations/Viewing-and-Editing.md#deal) by which the position was formed.
  ...
  * Reason — [reason for (#position-reason)](../Trading-Operations/Viewing-and-Editing.md#position-reason) opening a position.
