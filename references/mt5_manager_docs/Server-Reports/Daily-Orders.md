[🏠 Document Start](../README.md) / [Server Reports](README.md) / Daily Orders

[Previous](Daily-Trades.md) | [Next](Daily-Positions.md)

# Daily Orders Report

Daily Orders Report features information about [market and pending orders](../Trading-Operations/Working-with-Trading-Orders.md) which remained open (active) at the end of the selected day.
...
The report is presented as a table displaying the following order data:
  ...
  * Reason — [reason (#reason)](../Trading-Operations/Viewing-and-Editing.md#reason) for placing the order.
  * State — [order state (#order)](../Trading-Operations/Viewing-and-Editing.md#order) at the end of the day for which the report is generated.
