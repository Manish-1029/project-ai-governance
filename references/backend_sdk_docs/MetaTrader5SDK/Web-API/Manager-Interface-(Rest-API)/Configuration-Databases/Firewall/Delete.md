[🏠 Document Start](../../../../README.md) / [Web API](../../../README.md) / [Manager Interface (Rest API)](../../../Manager-Interface-(Rest-API).md) / [Configuration Databases](../../Configuration-Databases.md) / [Firewall](../Firewall.md) / Delete
...
Request Format
    ...
    GET /api/firewall/delete?index=indices
    POST /api/firewall/delete?index=indices
...
Request Format
    ...
    FIREWALL_DELETE|INDEX=indices\r\n

Response Format
    
    
    FIREWALL_DELETE|RETCODE=code description|\r\n
