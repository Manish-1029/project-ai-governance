[🏠 Document Start](../../../../README.md) / [Web API](../../../README.md) / [Manager Interface (Rest API)](../../../Manager-Interface-(Rest-API).md) / [Configuration Databases](../../Configuration-Databases.md) / [Firewall](../Firewall.md) / Shift
...
Request Format
    ...
    FIREWALL_SHIFT|INDEX=index|SHIFT=shift|\r\n

Response Format
    
    
    FIREWALL_SHIFT|RETCODE=code description|\r\n
