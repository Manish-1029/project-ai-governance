[🏠 Document Start](../../../../README.md) / [Web API](../../../README.md) / [Manager Interface (Rest API)](../../../Manager-Interface-(Rest-API).md) / [Configuration Databases](../../Configuration-Databases.md) / [Messengers](../Messengers.md) / Shift
...
Request Format
    ...
    MESSENGER_SHIFT|INDEX=index|SHIFT=shift|\r\n

Response Format
    
    
    MESSENGER_SHIFT|RETCODE=code description|\r\n
