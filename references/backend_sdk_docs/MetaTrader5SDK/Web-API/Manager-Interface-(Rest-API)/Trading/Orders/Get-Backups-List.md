[🏠 Document Start](../../../../README.md) / [Web API](../../../README.md) / [Manager Interface (Rest API)](../../../Manager-Interface-(Rest-API).md) / [Trading](../../Trading.md) / [Orders](../Orders.md) / Get Backups List

[Previous](Delete-Closed.md) | [Next](Get-from-Backup.md)
...
Request Format
    ...
    ORDER_BACKUP_LIST|FROM=beginning|TO=end|SERVER=identifiers|\r\n

Response Format
    
    
    ORDER_BACKUP_LIST|RETCODE=code description|\r\n
    List of dates
...
The received dates can be used in [/api/order/backup/get](Get-from-Backup.md) to request order data from specific backups.
